...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      setLoading(false)
      toast.success(result.data.message || "Sign-up successful! Redirecting...")
      navigate("/customize")
    } catch (error) {
      console.log(error)
      setUserData(null)
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <Toaster />
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000033] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
